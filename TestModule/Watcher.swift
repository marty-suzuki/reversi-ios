...
public final class Watcher<Element> {

    public var calledCount: Int { _calledCount.value }
    public var parameters: [Element] { _parameters.value }
    public var errors: [Error] { _errors.value }
    ...
    public init<T: ObservableType>(_ observable: T) where T.Element == Element {
